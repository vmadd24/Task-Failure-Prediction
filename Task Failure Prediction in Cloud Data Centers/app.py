...
def predict():
    if request.method == 'POST':
        ...
        if predict == 0:
            output='The Task / Job is Not Failed and Data is Transferred through Cloud is Successfully'
        elif predict == 1:
            output='The Task / Job is Failed and Data is Transferred through Cloud is Unsuccessfully'
